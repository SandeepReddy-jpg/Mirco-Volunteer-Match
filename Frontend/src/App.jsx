...
const sampleTasks = [
  ...
  { _id: 'sample-3', name: 'Food bank packing shift', description: 'Sort and pack essential food boxes for local families this weekend.', category: ['Community'], members: 10, accepted: [], time: '3 hrs', status: 'open' },
  { _id: 'sample-4', name: 'Neighbourhood mural day', description: 'Bring colour to a shared wall with local artists and neighbours.', category: ['Community'], members: 8, accepted: [], time: '4 hrs', status: 'open' },
  { _id: 'sample-5', name: 'River clean-up walk', description: 'Collect litter and protect the wildlife along the riverside trail.', category: ['Environment'], members: 12, accepted: [], time: '2 hrs', status: 'open' },
  { _id: 'sample-6', name: 'Homework club helper', description: 'Make learning feel easier for young students after school.', category: ['Education'], members: 5, accepted: [], time: '1.5 hrs', status: 'open' },
  { _id: 'sample-7', name: 'Warm meals delivery', description: 'Help deliver freshly prepared meals to neighbours who need support.', category: ['Community'], members: 7, accepted: [], time: '2 hrs', status: 'open' },
  { _id: 'sample-8', name: 'Seed swap host', description: 'Share seeds, planting tips, and a little optimism for the next season.', category: ['Environment'], members: 4, accepted: [], time: '1 hr', status: 'open' },
  { _id: 'sample-9', name: 'Resume review circle', description: 'Offer a practical second pair of eyes to someone starting their next chapter.', category: ['Education'], members: 4, accepted: [], time: '1 hr', status: 'open' },
]
